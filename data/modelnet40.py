"""
modified from https://github.com/erikwijmans/Pointnet2_PyTorch
changes:
    the dataset can return only coordinates without normal
    can deactivate the normalization
"""
...
class ModelNet40Cls(data.Dataset):
    def __init__(self, num_points, transforms=None, train=True, with_normal=False, download=True, normalize=False):
        super().__init__()
...
if __name__ == "__main__":
    ...
    dset = ModelNet40Cls(5000, train=True, transforms=transforms, download=True)
